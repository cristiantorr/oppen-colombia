...
if (!is_admin()) {
  ...
  add_filter('redirect_canonical', 'oppen_check_enum', 10, 2);
}

function oppen_check_enum($redirect, $request)
{
...
function oppen_autocomplete_login_init()
{
  ob_start();
}
add_action('login_init', 'oppen_autocomplete_login_init');

function oppen_autocomplete_login_form()
{
...
add_action('login_form', 'oppen_autocomplete_login_form');
...
function oppen_remove_headlinks()
{
...
add_action('init', 'oppen_remove_headlinks');
