      ...
      <div class="swiper swiper-banner-home">
        <div class="swiper-wrapper">
          <?php foreach ($bannerPauta as $banner) :
            $banner_link = $banner["link_banner"];
            $banner_image = $banner["banners_promotion"]; ?>

            <div class="swiper-slide">
              <figure>
                <a href="<?php echo esc_url($banner_link['url']); ?>" target="<?php echo esc_attr($pagelink['target'] ?? '_self'); ?>">
                  <img src="<?php echo esc_url($banner_image['url']); ?>" alt="Banner pauta">
                </a>
              </figure>
            </div>
          <?php endforeach; ?>
